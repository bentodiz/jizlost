...
StateMenuMain.prototype.Update = function()
{
	...
	else if (keyMenuSelect)
	{
		if (this.keyCooldown <= 0)
		{
			...
			if (this.selection == 0 && loadProgress >= 20)
				state = new StateGame();
...
StateMenuMain.prototype.Draw = function()
{
	...
	var items = [(loadProgress >= 20 ? "Start Game" : ("Loading... " + loadProgress + " / 20")), "Controls"];//, "Control Setup", "Credits"];
