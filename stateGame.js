...
function StateGame()
{
	...
	[
		...
		//{text:["Enemies will start", "to come down to attack", "the planet. Don't let them!!"],  x: WIDTH / 2 - 200, y: 100},
		{text:["Remaining pieces", "damage the planet", "", "Go for Perfects"], x: WIDTH / 2, y: 200},
